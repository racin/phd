...
func TestDelivery(t *testing.T) {
	...
	server := retrieval.New(swarm.MustParseHexAddress("0034"), mockStorer, nil, nil, logger, serverMockAccounting, pricerMock, nil, false, noopStampValidator, retrieval.Options{
		Enabled: &enabled,
	})
	...
	client := retrieval.New(clientAddr, clientMockStorer, recorder, mt, logger, clientMockAccounting, pricerMock, nil, false, noopStampValidator, retrieval.Options{
		Enabled: &enabled,
	})
...
func TestRetrieveChunk(t *testing.T) {
	...
	t.Run("downstream", func(t *testing.T) {
		...
		server := retrieval.New(serverAddress, serverStorer, nil, nil, logger, accountingmock.NewAccounting(), pricer, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
		...
		client := retrieval.New(clientAddress, nil, recorder, mt, logger, accountingmock.NewAccounting(), pricer, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
	...
	t.Run("forward", func(t *testing.T) {
		...
		server := retrieval.New(
			...
			nil,
			false,
			noopStampValidator, retrieval.Options{
				Enabled: &enabled,
			})
...
func TestRetrievePreemptiveRetry(t *testing.T) {
	...
	server1 := retrieval.New(serverAddress1, serverStorer1, nil, noClosestPeer, logger, accountingmock.NewAccounting(), pricerMock, nil, false, noopStampValidator, retrieval.Options{
		Enabled: &enabled,
	})
	server2 := retrieval.New(serverAddress2, serverStorer2, nil, noClosestPeer, logger, accountingmock.NewAccounting(), pricerMock, nil, false, noopStampValidator, retrieval.Options{
		Enabled: &enabled,
	})
	...
	t.Run("peer not reachable", func(t *testing.T) {
		...
		client := retrieval.New(clientAddress, nil, recorder, closetPeers, logger, accountingmock.NewAccounting(), pricerMock, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
	...
	t.Run("one peer is slower", func(t *testing.T) {
		...
		server1 := retrieval.New(serverAddress1, serverStorer1, nil, noClosestPeer, logger, server1MockAccounting, pricerMock, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
		server2 := retrieval.New(serverAddress2, serverStorer2, nil, noClosestPeer, logger, server2MockAccounting, pricerMock, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
		...
		client := retrieval.New(clientAddress, nil, recorder, closetPeers, logger, clientMockAccounting, pricerMock, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
	...
	t.Run("peer forwards request", func(t *testing.T) {
		...
		server1 := retrieval.New(serverAddress1, serverStorer1, server1Recorder, topologymock.NewTopologyDriver(topologymock.WithPeers(serverAddress2)), logger, accountingmock.NewAccounting(), pricerMock, nil, true, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
		...
		client := retrieval.New(clientAddress, nil, clientRecorder, topologymock.NewTopologyDriver(topologymock.WithPeers(serverAddress1)), logger, accountingmock.NewAccounting(), pricerMock, nil, false, noopStampValidator, retrieval.Options{
			Enabled: &enabled,
		})
...
func TestClosestPeer(t *testing.T) {
	...
	ret := retrieval.New(srvAd, nil, nil, topologymock.NewTopologyDriver(topologymock.WithPeers(addr1, addr2, addr3)), log.Noop, nil, nil, nil, false, nil, retrieval.Options{
		Enabled: &enabled,
	})
